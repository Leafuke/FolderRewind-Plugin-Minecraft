...
namespace MineRewind
{
    public partial class MinecraftSavesPlugin
    {
        private static readonly IReadOnlyDictionary<string, string> EnUsTexts = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["MineRewind_Hotkey_QuickRestore_Desc"] = "Ask MineBackup 3.1+ to restore the running world to the latest backup after its in-game countdown.",
            ...
            ["MineRewind_HotRestore_BroadcastFailed"] = "[MineRewind] The hot-restore request could not be sent. Direct restore was blocked.",
            ["MineRewind_HotRestore_TargetLatest"] = "the latest backup",
            ["MineRewind_HotRestore_TargetFile"] = "backup '{0}'",
            ["MineRewind_HotRestore_Requested"] = "[MineRewind] Hot restore of {0} was handed to MineBackup. Complete the countdown in game. Request ID: {1}",
        ...
        private static readonly IReadOnlyDictionary<string, string> ZhCnTexts = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["MineRewind_Hotkey_QuickRestore_Desc"] = "请求 MineBackup 3.1+ 在游戏内倒计时后，将正在运行的世界还原到最新备份。",
            ...
            ["MineRewind_HotRestore_BroadcastFailed"] = "[MineRewind] 无法发出热还原请求，已阻止直接还原。",
            ["MineRewind_HotRestore_TargetLatest"] = "最新备份",
            ["MineRewind_HotRestore_TargetFile"] = "备份“{0}”",
            ["MineRewind_HotRestore_Requested"] = "[MineRewind] 已将{0}的热还原请求交给 MineBackup，请在游戏内完成倒计时。请求 ID：{1}",
