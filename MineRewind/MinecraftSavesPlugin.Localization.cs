...
namespace MineRewind
{
    public partial class MinecraftSavesPlugin
    {
        private static readonly IReadOnlyDictionary<string, string> EnUsTexts = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["MineRewind_Hotkey_QuickRestore_Desc"] = "Restore the currently running Minecraft save to the latest backup through the companion handshake.",
            ...
            ["MineRewind_HotRestore_InvalidBackupId"] = "[MineRewind] The selected backup ID is unsafe. Direct restore was blocked.",
            ["MineRewind_HotRestore_ChannelUnavailable"] = "[MineRewind] The world is active, but the KnotLink hot-restore channel is unavailable. Direct restore was blocked.",
            ["MineRewind_HotRestore_StartFailed"] = "[MineRewind] The hot-restore handshake could not be started. Direct restore was blocked.",
            ["MineRewind_HotRestore_Busy"] = "[MineRewind] Another hot restore is already in progress. Direct restore was blocked.",
            ["MineRewind_HotRestore_TargetLatest"] = "the latest backup",
            ["MineRewind_HotRestore_TargetFile"] = "backup '{0}'",
            ["MineRewind_HotRestore_Started"] = "[MineRewind] Hot restore of {0} started through the companion handshake.",
        ...
        private static readonly IReadOnlyDictionary<string, string> ZhCnTexts = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["MineRewind_Hotkey_QuickRestore_Desc"] = "通过联动模组握手，将当前正在运行的 Minecraft 存档还原到最新备份。",
            ...
            ["MineRewind_HotRestore_InvalidBackupId"] = "[MineRewind] 所选备份标识不安全，已阻止直接还原。",
            ["MineRewind_HotRestore_ChannelUnavailable"] = "[MineRewind] 当前世界仍在运行，但 KnotLink 热还原通道不可用，已阻止直接还原。",
            ["MineRewind_HotRestore_StartFailed"] = "[MineRewind] 无法启动热还原握手，已阻止直接还原。",
            ["MineRewind_HotRestore_Busy"] = "[MineRewind] 已有热还原正在进行，已阻止直接还原。",
            ["MineRewind_HotRestore_TargetLatest"] = "最新备份",
            ["MineRewind_HotRestore_TargetFile"] = "备份“{0}”",
            ["MineRewind_HotRestore_Started"] = "[MineRewind] 已通过联动模组握手启动{0}的热还原。",
